...
public class RegisterActivity extends Activity {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !passwordCheck.isEmpty()) {
                    ...
                    {
                        Toast.makeText(getApplicationContext(), "비밀번호가 일치하지 않아요!", Toast.LENGTH_LONG).show();
                    }
                    else
                    {
                    ...
                    Toast.makeText(getApplicationContext(),
                            "회원가입 정보를 모두 입력해주세요!", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    params(tag, name, email, password) to register url */
